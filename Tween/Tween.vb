...
#End If
    ...
    Private Sub PostButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PostButton.Click
        If StatusText.Text.Length = 0 Then
        ...
        Dim tmpStatus As String = StatusText.Text
...
#End Region
    ...
    Private Sub FavoritesRetweetUnofficialEmpty(sender As System.Object, e As System.EventArgs)
        If Me.ExistCurrentPost AndAlso Not _curPost.IsDm Then
            _DoFavRetweetFlags = True
            FavoriteChange(True)
            _DoFavRetweetFlags = False
    ...
    Private Sub FavoriteRetweetUnofficialEmptyMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles FavoriteRetweetUnofficialEmptyMenuItem.Click
        FavoritesRetweetUnofficialEmpty(sender, e)
    End Sub

    Private Sub FavoriteRetweetUnofficialEmptyContextMenu_Click(sender As System.Object, e As System.EventArgs) Handles FavoriteRetweetUnofficialEmptyContextMenu.Click
        FavoritesRetweetUnofficialEmpty(sender, e)
    End Sub

    Private Sub FavUnOpMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles FavUnOpMenuItem.Click
        FavoriteUnofficial(sender, e)
    End Sub

    Private Sub FavUnAddToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles FavUnAddToolStripMenuItem.Click
        FavoriteUnofficial(sender, e)
    End Sub

    Private Sub FavoriteUnofficial(sender As System.Object, e As System.EventArgs)
        'RT @id:内容
        If Me.ExistCurrentPost Then
            If _curPost.IsDm OrElse _
               Not StatusText.Enabled Then Exit Sub
            ...
            StatusText.Text = "Fav @" + _curPost.ScreenName + ": " + HttpUtility.HtmlDecode(rtdata)
    ...
    Private Sub TweenMain_MaximizedBoundsChanged(sender As Object, e As System.EventArgs) Handles Me.MaximizedBoundsChanged
