...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  cQdJ8rClakcfhZgPGag に類似しているローカライズされた文字列を検索します。
        '''</summary>
        Friend ReadOnly Property ConsumerKey() As String
            Get
        ...
        '''<summary>
        '''  i05vzr2620OfmDTTggK3xw6CsGAq9b4M0BhoTm086Y に類似しているローカライズされた文字列を検索します。
        '''</summary>
        Friend ReadOnly Property ConsumerKeySecret() As String
            Get
                Return ResourceManager.GetString("ConsumerKeySecret", resourceCulture)
            End Get
        End Property
